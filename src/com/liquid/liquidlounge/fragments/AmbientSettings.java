...
public class AmbientSettings extends SettingsPreferenceFragment
    ...
    private static final String KEY_AOD = "doze_always_on";
    ...
    private SystemSettingSeekBarPreference mVibrateTilt;
    private SystemSettingSeekBarPreference mVibratePickup;
    private SystemSettingSeekBarPreference mVibrateProximity;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mVibrateTilt = (SystemSettingSeekBarPreference) findPreference(KEY_DOZE_VIBRATE_TILT);
        mVibrateTilt.setOnPreferenceChangeListener(this);

        mVibratePickup = (SystemSettingSeekBarPreference) findPreference(KEY_DOZE_VIBRATE_PICKUP);
    ...
    private void updateState() {
        ...
        if (mAODPreference != null) {
            mAODPreference.setChecked(Utils.aodEnabled(context));
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mDozePreference) {
            ...
            return true;
        } else if (preference == mAODPreference) {
            boolean value = (Boolean) newValue;
